...
def get_response(user_input: str) -> str:
    ...
    if lowered == '':
        ...
        return 'Oh, youve just crossed into dangerous territory, my friend. If you dont give me back my snacks, I might have to unleash the fury of a thousand dad jokes upon you. And trust me, you dont want to face that kind of punishment.'